...
import com.fred.wheelview.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	// private int[] SHADOWS_COLORS = new int[] { 0x30111111, 0x00AAAAAA,
	// 0x00AAAAAA };
	private int[] SHADOWS_COLORS = new int[] { 0x00000000, 0x00000000,
			0x00000000 };
	...
	/** Left and message_box02 padding value */
	...
	public void setWheelBackground(int resource) {
		...
		// setBackgroundResource(getResources().getColor(Color.WHITE));
	}
	...
	private void drawCenterRect(Canvas canvas) {
		 ...
		 * Rect(message_box01, top, message_box02, bottom) centerDrawable.setBounds(bounds)
